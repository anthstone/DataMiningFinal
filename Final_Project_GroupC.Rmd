...
# Add bathroom
# Remodel kitchen (check kitchen quality?)
...
reno_value = function(upgrade = c('add_bathroom', 'remodel_kitchen',
  ...
  # Check that the upgrades can be completed 
  
  
  # Return the new dataframe with cost and value estimates
  df = data.frame(est_cost = NA_real_, est_value = NA_real_)
  print(upgrade)
  if(str_detect(upgrade, "Error")) {

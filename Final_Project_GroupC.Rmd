...
housing$Kitchen.Qual <- factor(housing$Kitchen.Qual, levels = c('DNE', 'Fa', 'TA', 'Gd', 'Ex'))
...
#Show rowss that have at least one NA
...
if (sum(is.na(housing)) >0) {
  ...
  DNE.Cols = c(74,75,76,32,33,34,35,37,8,59,65,66,62,60,29,30, 27,44,55)
  ...
  #remove all BLANKS and change them to NA
  for (i in catchall.cols){
    housing[[i]][housing[[i]]==""] <- NA
  }
  
  #Change NAs in specified qual variables to DNE
  for (i in DNE.Cols){
...
glm.pred = predict(glm, housing[housing$Yr.Sold == 2010,], type= "response")
...
### i). Forward Stepwise Model Accuracy
```{r}
# Use performance_metrics function defined above for all models
performance_metrics(actual = housing[housing$Yr.Sold == 2010, 'SalePrice'],forward_pred, plot = T, by_neighborhood = F)

```

### ii).Bakcward Stepwise Model Accuracy
```{r}
# Use performance_metrics function defined above for all models
performance_metrics(actual = housing[housing$Yr.Sold == 2010, 'SalePrice'], backward_pred, plot = T, by_neighborhood = F)

```

### iii). GLM Model Accuracy
```{r}
# Use performance_metrics function defined above for all models
#performance_metrics(actual = housing[housing$Yr.Sold == 2010, 'SalePrice'], glm.pred, plot = T, by_neighborhood = F)

```

### iv). Lasso Model Accuracy
```{r}
# Use performance_metrics function defined above for all models
performance_metrics(actual = housing[housing$Yr.Sold == 2010, 'SalePrice'], lasso_pred, plot = T, by_neighborhood = F)

```

### v). Boosted Model Accuracy
```{r}
# Use performance_metrics function defined above for all models
performance_metrics(actual = housing[housing$Yr.Sold == 2010, 'SalePrice'], boost_pred, plot = T, by_neighborhood = F)
...
```{r}
# Use performance_metrics function defined above for all models
performance_metrics(predicted = forward_pred, by_neighborhood = T)
...
```{r}
# Use performance_metrics function defined above for all models
performance_metrics(actual = housing[housing$Yr.Sold == 2010, 'SalePrice'], backward_pred, plot = T, by_neighborhood = T)
...
```{r}
# Use performance_metrics function defined above for all models
performance_metrics(actual = housing[housing$Yr.Sold == 2010, 'SalePrice'], lasso_pred, plot = T, by_neighborhood = T)
...
```{r}
# Use performance_metrics function defined above for all models
performance_metrics(actual = housing[housing$Yr.Sold == 2010, 'SalePrice'], boost_pred, plot = T, by_neighborhood = T)

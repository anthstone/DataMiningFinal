...
if (sum(is.na(housing)) >0) {
  ...
  DNE.Cols = c(74,75,76,32,33,34,35,37,8,59,65,66,62,60,29,30, 27,44)
...
# 
# housing.factors$MS.SubClass <- factor(housing.factors$MS.SubClass , levels = c(0, 20, 30, 40, 45, 50, 60, 70, 75, 80, 90, 120, 150, 160, 180, 190))
# 
# sum(is.na(housing.factors))
# 
# #Show columns that have at least one NA
# housing.factors[, colSums(is.na(housing.factors)) > 0]
# 
# #Show rowss that have at least one NA
# housing.factors[rowSums(is.na(housing.factors)) > 0,]
...
#glm.pred = predict(glm, housing[housing$Yr.Sold == 2010,])

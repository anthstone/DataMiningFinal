...
```
# Manually doing the NAs
```{r}
#putting all the NA alleys to 'none'
housing$Alley <- as.character(housing$Alley)
housing$Alley[is.na(housing$Alley)] <- "none"
as.factor(housing$Alley)

#putting all the NA Fence to 'none' since NA means there is no fence
housing$Fence <- as.character(housing$Fence)
housing$Fence[is.na(housing$Fence)] <- "none"

#putting all the NA Fence to 'none' since NA means there is no fence
housing$Misc.Feature <- as.character(housing$Misc.Feature)
housing$Misc.Feature[is.na(housing$Misc.Feature)] <- "none"

# #putting all the NA Garage finish to 'none' since NA means there is no fence
# housing$Garage.Finish <- as.character(housing$Garage.Finish)
# housing$Garage.Finish[is.na(housing$Garage.Finish)] <- "none"
# housing$Garage.Finish <- as.factor(housing$Garage.Finish)

str(housing)

## quality vars
#Pool.QC to DNE
housing$Pool.QC <- as.character(housing$Pool.QC)
housing$Pool.QC[is.na(housing$Pool.QC)] <- "DNE"
housing$Pool.QC <- as.factor(housing$Pool.QC)

housing$Garage.Cond <- as.character(housing$Garage.Cond)
housing$Garage.Cond[is.na(housing$Garage.Cond)] <- "DNE"
housing$Garage.Cond <- as.factor(housing$Garage.Cond)

housing$Garage.Qual <- as.character(housing$Garage.Qual)
housing$Garage.Qual[is.na(housing$Garage.Qual)] <- "DNE"
housing$Garage.Qual <- as.factor(housing$Garage.Qual)

housing$Garage.Type <- as.character(housing$Garage.Type)
housing$Garage.Type[is.na(housing$Garage.Type)] <- "DNE"
housing$Garage.Type <- as.factor(housing$Garage.Type)

housing$Garage.Finish <- as.character(housing$Garage.Finish)
housing$Garage.Finish[is.na(housing$Garage.Finish)] <- "DNE"
housing$Garage.Finish <- as.factor(housing$Garage.Finish)

housing$Fireplace.Qu <- as.character(housing$Fireplace.Qu)
housing$Fireplace.Qu[is.na(housing$Fireplace.Qu)] <- "DNE"
housing$Fireplace.Qu <- as.factor(housing$Fireplace.Qu)

housing$BsmtFin.Type.2 <- as.character(housing$BsmtFin.Type.2)
housing$BsmtFin.Type.2[is.na(housing$BsmtFin.Type.2)] <- "DNE"
housing$BsmtFin.Type.2 <- as.factor(housing$BsmtFin.Type.2)
# str(housing)
housing$BsmtFin.Type.1 <- as.character(housing$BsmtFin.Type.1)
housing$BsmtFin.Type.1[is.na(housing$BsmtFin.Type.1)] <- "DNE"
housing$BsmtFin.Type.1 <- as.factor(housing$BsmtFin.Type.1)

housing$Bsmt.Cond <- as.character(housing$Bsmt.Cond)
housing$Bsmt.Cond[is.na(housing$Bsmt.Cond)] <- "DNE"
housing$Bsmt.Cond <- as.factor(housing$Bsmt.Cond)

housing$Bsmt.Qual <- as.character(housing$Bsmt.Qual)
housing$Bsmt.Qual[is.na(housing$Bsmt.Qual)] <- "DNE"
housing$Bsmt.Qual <- as.factor(housing$Bsmt.Qual)
...
housing$Bsmt.Exposure <- as.character(housing$Bsmt.Exposure)
housing$Bsmt.Exposure[is.na(housing$Bsmt.Exposure)] <- "DNE"
housing$Bsmt.Exposure <- as.factor(housing$Bsmt.Exposure)

housing$MS.SubClass <- as.character(housing$MS.SubClass)
housing$MS.SubClass[is.na(housing$MS.SubClass)] <- "DNE"
housing$MS.SubClass <- as.factor(housing$MS.SubClass)

###########just for testing######################################################################
# not sure about electrical snd mass.vnr.type to be DNE. rmeoving them since its just 1+23 values
housing <- 
  housing %>%
  na.omit(housing, cols = c("Electrical", "Mass.Vnr.Type"))
